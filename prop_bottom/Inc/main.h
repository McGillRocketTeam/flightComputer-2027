...
/* Private defines -----------------------------------------------------------*/
#define ADC1_MOV_HALL_Pin GPIO_PIN_1
#define ADC1_MOV_HALL_GPIO_Port GPIOA
#define CS_FLASH_Pin GPIO_PIN_2
#define CS_FLASH_GPIO_Port GPIOA
#define BD1_nINT_Pin GPIO_PIN_3
#define BD1_nINT_GPIO_Port GPIOA
#define CS_BD1_Pin GPIO_PIN_4
#define CS_BD1_GPIO_Port GPIOA
